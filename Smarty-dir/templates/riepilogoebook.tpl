...
<main role="main">
                ...
                <table id="customers">
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>{$ebook->getTitolo()}</td>
                            <td>{$ebook->getAutore()}</td>
                            <td>{$ebook->getEditore()}</td>
                            <td>{$ebook->getGenere()}</td>
                            <td>{$ebook->getAnno()}</td>
                            <td>{$ebook->getprezzo()}</td>
    ...
    <div class="testo-centrato">
        <h2>L'Ebook è stato spedito all'indirizzo e-mail: {$email}</h2>
        <h2>Il nuovo saldo punti è {$saldo}</h2>

<?php
/* Smarty version 3.1.34-dev-7, created on 2020-05-20 17:47:14
  from '/opt/lampp/htdocs/booksharing/Smarty-dir/templates/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5ec55102c7ca02_55240735',
...
function content_5ec55102c7ca02_55240735 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
>
	<!-- Slick slider -->
    <?php echo '<script'; ?>
 type="text/javascript" src="../assets/js/slick.min.js"><?php echo '</script'; ?>
>
    <!-- Counter js -->
    <?php echo '<script'; ?>
 type="text/javascript" src="../assets/js/counter.js"><?php echo '</script'; ?>
>
    <!-- Ajax contact form  -->
    <?php echo '<script'; ?>
 type="text/javascript" src="../assets/js/app.js"><?php echo '</script'; ?>
>
    ...
    <!-- Custom js -->
	<?php echo '<script'; ?>
 type="text/javascript" src="../assets/js/custom.js"><?php echo '</script'; ?>
>

<?php
/* Smarty version 3.1.34-dev-7, created on 2020-06-04 20:01:11
  from 'C:\xampp\htdocs\booksharing\Smarty-dir\templates\modificautente.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5ed936e77e8a31_01809723',
...
function content_5ed936e77e8a31_01809723 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
...
<br></output>
 ...
 name="password" ><br>
                                    email<br>
                                    <input type="email"  placeholder="<?php echo $_smarty_tpl->tpl_vars['user']->value->getemail();?>
...
"><br>
                                    CAP<br>
                                    <input type="text" name="cap" pattern=<?php echo $_smarty_tpl->tpl_vars['cap']->value;?>
  placeholder="<?php echo $_smarty_tpl->tpl_vars['user']->value->getindirizzo()->getcap();?>
"><br>
                                    Comune<br>
                                    <input type="text" name="comune" placeholder="<?php echo $_smarty_tpl->tpl_vars['user']->value->getindirizzo()->getComune();?>
"><br>
                                    Provincia<br>
                                    <input type="text" name="provincia" placeholder="<?php echo $_smarty_tpl->tpl_vars['user']->value->getindirizzo()->getprovincia();?>
"><br>

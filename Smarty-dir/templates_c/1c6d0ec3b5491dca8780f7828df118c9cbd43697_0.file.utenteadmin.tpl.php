<?php
/* Smarty version 3.1.34-dev-7, created on 2020-06-10 18:06:19
  from '/opt/lampp/htdocs/booksharing/Smarty-dir/templates/utenteadmin.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5ee104fb040103_36903951',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1c6d0ec3b5491dca8780f7828df118c9cbd43697' => 
    array (
      0 => '/opt/lampp/htdocs/booksharing/Smarty-dir/templates/utenteadmin.tpl',
      1 => 1591805083,
      2 => 'file',
    ),
  ),
...
function content_5ee104fb040103_36903951 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
...
?>
                    <form method="post" action="/booksharing/Admin/eliminautente/<?php echo $_smarty_tpl->tpl_vars['x']->value->getuser();?>
">

                        <tr>
                            <?php if ($_smarty_tpl->tpl_vars['x']->value->getuser() != 'admin') {?>
                            <td>
                                <div class="bottone">

                                    <input type="radio" name="registrato" value="user">
                                    <div class="ciao"><?php echo $_smarty_tpl->tpl_vars['x']->value->getuser();?>
</div><br>

                                </div>
                            </td>

                            <td><?php echo $_smarty_tpl->tpl_vars['x']->value->getuser();?>
</td>
                            <td><?php echo $_smarty_tpl->tpl_vars['x']->value->getpsw();?>
</td>
                            <td><?php echo $_smarty_tpl->tpl_vars['x']->value->getnome();?>
</td>
                            <td><?php echo $_smarty_tpl->tpl_vars['x']->value->getcognome();?>
</td>
                            <td><?php echo $_smarty_tpl->tpl_vars['x']->value->getemail();?>
</td>
                            <td><?php echo $_smarty_tpl->tpl_vars['x']->value->getindirizzo()->getvia();?>
</td>
                            <td><?php echo $_smarty_tpl->tpl_vars['x']->value->getindirizzo()->getNcivico();?>
</td>
                            <td><?php echo $_smarty_tpl->tpl_vars['x']->value->getindirizzo()->getcap();?>
</td>
                            <td><?php echo $_smarty_tpl->tpl_vars['x']->value->getindirizzo()->getComune();?>
</td>
                            <td><?php echo $_smarty_tpl->tpl_vars['x']->value->getindirizzo()->getprovincia();?>
</td>
